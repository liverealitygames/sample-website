    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Casting', 'Casting'), ('Running', 'Running'), ('Hiatus', 'Hiatus'), ('Defunct', 'Defunct'), ('Unknown', 'Unknown'), ('Under Review', 'Under Review')], max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_time', models.DateTimeField(auto_now_add=True)),
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('wiki', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('other_link', models.CharField(blank=True, max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('status', models.CharField(choices=[('Casting', 'Casting'), ('Running', 'Running'), ('Finished', 'Finished'), ('Under Review', 'Under Review')], max_length=256)),
                ('filmed', models.BooleanField(blank=True, null=True)),
                ('application_link', models.CharField(blank=True, max_length=256, null=True)),
                ('format', models.CharField(choices=[('Amazing Race', 'Amazing Race'), ('Big Brother', 'Big Brother'), ('Survivor', 'Survivor'), ('The Challenge', 'The Challenge'), ('The Mole', 'The Mole'), ('Traitors', 'Traitors'), ('Taskmaster', 'Taskmaster')], max_length=256)),
                ('banner', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.externalimage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contacts', models.ManyToManyField(related_name='staff_as_contact', to='profiles.profile')),
                ('general', models.ManyToManyField(related_name='staff_as_general', to='profiles.profile')),
                ('hosts', models.ManyToManyField(related_name='staff_as_host', to='profiles.profile')),
            ],
            options={
                'abstract': False,
            },
