    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Casting', 'Casting'), ('Running', 'Running'), ('Hiatus', 'Hiatus'), ('Defunct', 'Defunct'), ('Unknown', 'Unknown')])),
                ('banner', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.externalimage')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='communities_owned', to='homepage.profile')),
                ('staff', models.ManyToManyField(related_name='communities_as_staff', to='homepage.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('status', models.CharField(choices=[('Casting', 'Casting'), ('Running', 'Running'), ('Finished', 'Finished')])),
                ...
                ('game_format', models.CharField(choices=[('Amazing Race', 'Amazing Race'), ('Big Brother', 'Big Brother'), ('Custom', 'Custom'), ('Survivor', 'Survivor'), ('The Challenge', 'The Challenge'), ('The Mole', 'The Mole'), ('Traitors', 'Traitors'), ('Taskmaster', 'Taskmaster'), ('Other', 'Other')])),
                ('cast', models.ManyToManyField(related_name='seasons_as_cast', to='homepage.profile')),
                ...
                ('schedule', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='community.schedule')),
                ('season_banner', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.externalimage')),
                ('staff', models.ManyToManyField(related_name='seasons_as_staff', to='homepage.profile')),
            ],
            options={
                'abstract': False,
            },
