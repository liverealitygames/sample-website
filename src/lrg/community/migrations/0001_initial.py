    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.CharField(choices=[('Amazing Race', 'Amazing Race'), ('Big Brother', 'Big Brother'), ('Custom', 'Custom'), ('Survivor', 'Survivor'), ('The Challenge', 'The Challenge'), ('The Mole', 'The Mole'), ('Traitors', 'Traitors'), ('Taskmaster', 'Taskmaster'), ('Other', 'Other')])),
            ],
            options={
                'abstract': False,
            },
